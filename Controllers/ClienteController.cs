...
namespace Astromaze.Controllers
{
    public class ClienteController : Controller
    {
        ...
        {
            var listEspecie = new List<SelectListItem>();
            listEspecie.Add(new SelectListItem() { Text = "Particular", Value = "Particular" });
            listEspecie.Add(new SelectListItem() { Text = "Empresa", Value = "Empresa" });
            listEspecie.Add(new SelectListItem() { Text = "Selecione uma opção", Value = "", Selected = true });

            ViewBag.listEspecie = listEspecie;
        ...
        public ActionResult Edit(int id, Cliente cliente)
        {
            try
            {
                ...
                listaExistente.Especie = cliente.Especie;
